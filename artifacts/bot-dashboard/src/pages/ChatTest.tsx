  ...
  const [messages, setMessages] = useState<LocalMessage[]>([
    {
      ...
      role: "bot",
      content:
        "¡Hola! Soy tu asistente virtual inteligente. ¿En qué te puedo ayudar hoy?",
      ...
      <div className="lg:w-96 flex flex-col gap-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Monitorea el razonamiento del bot en tiempo real para el último
            mensaje.
          </p>
        </div>
        ...
        {lastBotMessage?.meta ? (
            ...
            <div>
              ...
              <div className="w-full h-1.5 bg-secondary rounded-full mt-3 overflow-hidden">
                <motion.div
                  initial={{ width: 0 }}
                  animate={{
                    width: `${(lastBotMessage.meta.confidence || 0) * 100}%`,
                  }}
          ...
          <div className="bg-card/50 border border-border/50 border-dashed rounded-2xl p-8 flex flex-col items-center justify-center text-center h-64 text-muted-foreground">
            ...
            <p>
              Envía un mensaje en el simulador para ver el análisis de la IA en
              tiempo real.
            </p>
          </div>
        )}
        ...
        <div className="bg-primary/10 border border-primary/20 rounded-2xl p-5 mt-auto">
          ...
          <ul className="text-sm text-primary/80 space-y-2">
            <li className="flex gap-2">
              <ChevronRight size={16} className="shrink-0 mt-0.5" /> Intenta
              preguntar por un producto específico para activar el Agente de
              Ventas.
            </li>
            <li className="flex gap-2">
              <ChevronRight size={16} className="shrink-0 mt-0.5" /> Quejate de
              un problema para ver cómo el Agente de Soporte toma el control.
            </li>
          </ul>
        </div>
      </div>
